      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 fade-in">
          <h2 className="text-4xl md:text-6xl font-black font-orbitron text-white mb-4">
            CAREER <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">JOURNEY</span>
          </h2>
        ...
        <div ref={timelineRef} className="relative">
          {/* Timeline line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-cyan-400 to-purple-500 timeline-line transition-all duration-2000" style={{ height: '0%' }} />

          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <div key={exp.id} className={`experience-card flex items-center opacity-0 transform ${
                index % 2 === 0 ? 'translate-x-[-100px] flex-row' : 'translate-x-[100px] flex-row-reverse'
              } transition-all duration-700`}>
                {/* Card content */}
                <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                  <div className="glass-dark p-6 rounded-2xl hover-lift hover-glow transition-all duration-300 group">
                    {/* Status badge */}
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                        exp.status === 'current' ? 'bg-green-500' : 'bg-blue-500'
                      } text-white`}>
                ...
                <div className="w-2/12 flex justify-center">
                  <div className={`timeline-dot w-6 h-6 rounded-full bg-gradient-to-r ${exp.color} border-4 border-gray-900 z-10 pulse`} />
                </div>
          ...
          <div className="mt-16 text-center fade-in">
            <div className="glass-dark p-6 rounded-2xl max-w-lg mx-auto">
              ...
              <div className="space-y-2">
                <h4 className="text-lg font-semibold text-cyan-400">B.Sc. in Biosciences</h4>
