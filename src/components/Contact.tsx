...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/harshkuhikar68@gmail.com', {
        method: 'POST',
        headers: {
          ...
          <div className="contact-animate opacity-0 transform translate-x-[-50px] transition-all duration-700 space-y-8">
            <div className="glass-dark p-6 rounded-2xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 group">
                  <div className="contact-icon p-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 text-white floating" style={{ animationDelay: '0.5s' }}>
                    <Phone size={20} />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-4 group">
                  <div className="contact-icon p-3 rounded-full bg-gradient-to-r from-green-400 to-teal-500 text-white floating" style={{ animationDelay: '1s' }}>
                    <MapPin size={20} />
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">Location</p>
                    <p className="text-white text-lg">Vastral, Ahmedabad</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <Github className="text-cyan-400 group-hover:text-white" size={24} />
                  </a>
                  <a 
                    href="#"
                    className="contact-icon p-3 rounded-full glass hover-lift hover-glow transition-all duration-300 group"
            ...
            <div className="glass-dark p-6 rounded-2xl text-center">
              <div className="w-32 h-32 mx-auto mb-4 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full flex items-center justify-center pulse">
                <div className="w-24 h-24 bg-gray-900 rounded-full flex items-center justify-center">
                  <span className="text-2xl font-bold text-cyan-400">HK</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === 'error' && (
                  <div className="p-4 bg-red-500 bg-opacity-20 border border-red-500 rounded-lg">
                    <p className="text-red-400 text-sm">Something went wrong. Please try again or contact me directly.</p>
                  </div>
                )}
              </form>
            </div>
