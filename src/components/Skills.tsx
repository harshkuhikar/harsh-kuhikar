...
import { Code, Palette, Smartphone, Database, GitBranch, Zap } from 'lucide-react';
  ...
  const skills = [
    {
      ...
      items: ["HTML5", "CSS3", "JavaScript", "React.js", "jQuery", "Bootstrap", "SASS/LESS"],
      color: "from-cyan-400 to-blue-500"
    },
    {
      category: "Design Conversions",
      icon: <Palette className="w-8 h-8" />,
      items: ["PSD to HTML", "Figma to HTML", "Sketch to Code", "Adobe XD to HTML"],
      color: "from-purple-400 to-pink-500"
    },
    {
      category: "Responsive & UI",
      icon: <Smartphone className="w-8 h-8" />,
      items: ["Responsive Web Design", "SCSS", "Tailwind CSS", "Mobile-First Design"],
      color: "from-green-400 to-teal-500"
    },
    {
      category: "CMS & Backend",
      icon: <Database className="w-8 h-8" />,
      items: ["WordPress", "PHP Basics", "MySQL", "REST APIs"],
    ...
    },
    {
      ...
      items: ["Web Optimization", "SEO", "Performance Tuning", "Cross-browser Testing"],
      ...
      <div ref={skillsRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Cutting-edge technologies and frameworks I use to create exceptional digital experiences
          </p>
        </div>
          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="flex items-center mb-6">
                <div className={`p-3 rounded-full bg-gradient-to-r ${skill.color} text-white mr-4`}>
                  {skill.icon}
                </div>
